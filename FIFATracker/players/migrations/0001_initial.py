    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aisd', models.IntegerField(blank=True, null=True)),
                ('knkp', models.IntegerField(blank=True, null=True)),
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='teams', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='teamplayerlinks', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commonname', models.ForeignKey(db_column='commonnameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commonname', to='players.DataPlayernames19')),
                ('firstname', models.ForeignKey(db_column='firstnameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='firstname', to='players.DataPlayernames19')),
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='players19', to=settings.AUTH_USER_MODEL)),
                ('lastname', models.ForeignKey(db_column='lastnameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lastname', to='players.DataPlayernames19')),
                ('nationality', models.ForeignKey(db_column='nationality', null=True, on_delete=django.db.models.deletion.CASCADE, to='players.DataNations19')),
                ('playerjerseyname', models.ForeignKey(db_column='playerjerseynameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='playerjerseyname', to='players.DataPlayernames19')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accessorycolourcode2', models.IntegerField(blank=True, null=True)),
                ('facialhaircolorcode', models.IntegerField(blank=True, null=True)),
                ('commonname', models.ForeignKey(db_column='commonnameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commonname', to='players.DataPlayernames17')),
                ('firstname', models.ForeignKey(db_column='firstnameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='firstname', to='players.DataPlayernames17')),
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='players17', to=settings.AUTH_USER_MODEL)),
                ('lastname', models.ForeignKey(db_column='lastnameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lastname', to='players.DataPlayernames17')),
                ('nationality', models.ForeignKey(db_column='nationality', null=True, on_delete=django.db.models.deletion.CASCADE, to='players.DataNations17')),
                ('playerjerseyname', models.ForeignKey(db_column='playerjerseynameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='playerjerseyname', to='players.DataPlayernames17')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accessorycolourcode2', models.IntegerField(blank=True, null=True)),
                ('facialhaircolorcode', models.IntegerField(blank=True, null=True)),
                ('commonname', models.ForeignKey(db_column='commonnameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commonname', to='players.DataPlayernames')),
                ('firstname', models.ForeignKey(db_column='firstnameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='firstname', to='players.DataPlayernames')),
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='players', to=settings.AUTH_USER_MODEL)),
                ('lastname', models.ForeignKey(db_column='lastnameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lastname', to='players.DataPlayernames')),
                ('nationality', models.ForeignKey(db_column='nationality', null=True, on_delete=django.db.models.deletion.CASCADE, to='players.DataNations')),
                ('playerjerseyname', models.ForeignKey(db_column='playerjerseynameid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='playerjerseyname', to='players.DataPlayernames')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='playerloans', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bodytypecode', models.IntegerField(blank=True, null=True)),
                ('faceposerpreset', models.IntegerField(blank=True, null=True)),
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='manager', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='leagueteamlinks', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='leagues', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surname', models.CharField(blank=True, max_length=45, null=True)),
                ('playerid', models.IntegerField(blank=True, null=True)),
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='editedplayernames', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dcplayernames', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='youthplayers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='careerusers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='DataUsersCareerRestReleaseClauses',
            fields=[
                ('primary_key', models.BigAutoField(primary_key=True, serialize=False)),
                ('username', models.CharField(blank=True, db_index=True, max_length=150, null=True)),
                ('ft_slot', models.IntegerField(blank=True, null=True)),
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='releaseclauses', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='playercontract', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='DataUsersCareerCompdataPlayerStats',
            fields=[
                ('primary_key', models.BigAutoField(primary_key=True, serialize=False)),
                ('username', models.CharField(blank=True, db_index=True, max_length=150, null=True)),
                ('ft_slot', models.IntegerField(blank=True, null=True)),
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='compdataplayerstats', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='calendar', to=settings.AUTH_USER_MODEL)),
            ],
            options={
