    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='calendar', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='playercontract', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='careerusers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='youthplayers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='dcplayernames', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playerjerseyname', models.CharField(
                    blank=True, max_length=45, null=True)),
                ('surname', models.CharField(blank=True, max_length=45, null=True)),
                ('playerid', models.IntegerField(blank=True, null=True)),
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='editedplayernames', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='leagueteamlinks', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='playerloans', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nationality', models.ForeignKey(db_column='nationality', null=True,
                                                  on_delete=django.db.models.deletion.CASCADE, to='players.DataNations')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facialhaircolorcode', models.IntegerField(blank=True, null=True)),
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='players17', to=settings.AUTH_USER_MODEL)),
                ('nationality', models.ForeignKey(db_column='nationality', null=True,
                                                  on_delete=django.db.models.deletion.CASCADE, to='players.DataNations17')),
                ('commonnameid', models.IntegerField(blank=True, null=True)),
                ('firstnameid', models.IntegerField(blank=True, null=True)),
                ('lastnameid', models.IntegerField(blank=True, null=True)),
                ('playerjerseynameid', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ft_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='teamplayerlinks', to=settings.AUTH_USER_MODEL)),
            ],
            options={
